...
export class Form_1Page {
  ...
  send() {
    if (this.credentialsForm.valid) {
      ...
      // this.details.email, this.details.firstname, this.details.lastname, this.details.phone, this.details.location, this.details.ridetype, this.r_banktype, this.r_account_number, this.r_color, this.image, this.car_reg, this.pass, this.insurance, this.car_photo, this.license
      this.bmpapiProvider.register('').subscribe((event: HttpEvent<any>) => {
        //get upload progress
        loading.dismiss();
        this.form = false;
