...
this.longi=res.coords.longitude;
				...
				this.toastCtrl.create({
					message: "La position de votre appareil n'est pas disponible. Veuillez allumer votre GPS.",
					position: 'middle',
	...
	location() {
		...
		content: "Confirmation de l'arrivée ..."
		});
		loading.present();
      ...
      this.watches.unsubscribe();
		...
		message: "Une erreur Internet š'est produite, réessayer",
			duration: 3000
			});
			toast.present();
		});
